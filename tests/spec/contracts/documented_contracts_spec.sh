...
Describe 'documented CLI contracts'
  ...
  It 'documents eager discipline delivery without a selective-loading path'
    for domain in __base iac-basic qa-basic sdlc-full sdlc-light vault-memory; do
      index="$CONTRACT_ROOT/domains/$domain/disciplines/index.md"
      The contents of file "$index" should include 'delivered at context start'
    ...
    The contents of file "$CONTRACT_ROOT/domains/__base/index.md" should include '`cumaru-first` as the priority gate'
  End
