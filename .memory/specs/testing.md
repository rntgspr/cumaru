...
mode, and symlink targets where contract-relevant. Update tests assert the
clean-Git preflight, direct mutation behavior, and absence of project-local
lock/staging/backup/recovery debris.
...
| [`../../tests/spec/update/`](../../tests/spec/update/) | Content ownership, tags, dry-run, versions, clean-Git preflight, and direct mutation behavior. |
