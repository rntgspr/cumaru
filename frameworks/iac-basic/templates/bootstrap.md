...
by `cumaru topology bootstrap` (light pass) and grown by future
`cumaru topology deep <area>` invocations. Leave it on disk after editing — it is
...
# Light pass — your job
  ...
  2. Write `topology/<area>/index.md` following `templates/spec.md`:
