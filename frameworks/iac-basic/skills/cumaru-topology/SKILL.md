...
8. Re-emit `topology/index.md` row via `cumaru tag set topology/index.md topology <new body>` — v4 shape: `| [<area>](<area>/index.md) | <one-line description fusing summary, apps, depends-on (= apply order), relates> |`.
9. `cumaru doctor` — orphan check clean.
...
7. Re-emit `topology/index.md`. `cumaru doctor`.
...
5. Re-emit `topology/index.md` row. `cumaru doctor`.
