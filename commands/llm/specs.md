...
1. **Read the `llm-specs` skill** at `.llm/skills/llm-specs/SKILL.md`. It carries the three recipes: bootstrap, deepen, consolidate. Follow its layout and pre-checks (Lead-only authoring; `deltas:` ↔ `consolidated-at:` state model).
