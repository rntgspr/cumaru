...
- [intake-ticket.md](intake-ticket.md) — `intake/tickets/<JIRA-ID>/index.md`
- [intake-story.md](intake-story.md) — `intake/stories/<JIRA-ID>/index.md` (includes `## Coordination` section)
- [intake-epic.md](intake-epic.md) — `intake/epics/<JIRA-ID>/index.md`
- [review.md](review.md) — `reviews/<PLAN-ID>-review.md`
...
- [bootstrap.md](bootstrap.md) — `specs/<area>/bootstrap.md` (persistent discovery log: created by `llm specs bootstrap`, grown by `llm specs deep <area>`). Carries the BOOTSTRAP-INSTRUCTIONS block plus the per-pass `## Discovery` sections.
