...
Subcommands
  ...
  Marker blocks
    ...
    tag all [--body|--rows]                 list tag blocks in every .cumaru/*.md
  ...
  State maintenance
    ...
    update agent [<name>] [--apply|--clear]  install, or immediately clear one/all agent sets
    update skills [<name>] [--with <skill>...] [--apply|--clear]  install skills or opt-ins
    update commands [<name>] [--apply|--clear]  install, or immediately clear commands
...
Examples
  ...
  cumaru install                       install the starter once at ./.cumaru
  ...
  cumaru update agent --clear          immediately clear every Cumaru adapter artifact
  cumaru update skills codex --with git --apply
                                       add the Git opt-in to an existing install
