...
| Refresh or clear framework-owned project artifacts | `cumaru update`; install and refresh preview unless `--apply` is explicit, while `--clear` removes immediately after the conditional Git recovery check. |
