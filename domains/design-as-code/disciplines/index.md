---
human_revised: false
summary: "Execution disciplines delivered eagerly and applied by task trigger to govern design-domain work."
targets: [meta]
---
...
metadata. Evaluate `cumaru-first` first. The domain's execution-discipline
table lists the design-specific triggers; this domain does not ship
`code-comments`.
