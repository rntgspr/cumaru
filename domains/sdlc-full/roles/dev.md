...
Do **not** load shallow pillar indexes (`intake/index.md`, `plans/index.md`, etc.), other concerns, sibling areas, `archive/`, `exploring/`, or `issues/` unless the user explicitly asks. Shallows are noise during execution.
