...
If code you authored during the current task preceded its test, revert only that
new work and restart the cycle. Pre-existing code and other contributors' work
stay intact; characterize existing behavior with a regression test before
changing it.
