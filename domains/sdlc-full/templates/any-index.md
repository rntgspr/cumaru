...
targets: [meta] # component scope: `meta` means .cumaru/ itself; replace
# with your component keys from config.yaml meta.targets.values
...
<!-- For ideation/active pillars. Rename to "## When to consult" when useful. -->
