...
Proposed changes to `specs/` resulting from this plan. **The Lead validates and finalizes** as `plans/<PLAN-ID>/delta-draft.md` during direct absorption. Do not edit `specs/` directly.
