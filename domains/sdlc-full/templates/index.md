...
- [any-index.md](any-index.md) — generic shape for any pillar's shallow `index.md` (header + table + Rules + When to use / NOT use). Use as the starting point for `intake/index.md`, `plans/index.md`, `archive/index.md`, `specs/index.md`, `exploring/index.md`, `issues/index.md`.
