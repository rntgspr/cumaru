...
- `delta-draft.md` — finalized in place (Lead, finalized from the Dev's draft during absorption flow)
- [spec.md](spec.md) — `specs/<area>/index.md` (Lead)
- [exploration.md](exploration.md) — `exploring/<slug>/index.md` (Lead)
- [issue.md](issue.md) — `issues/<slug>/index.md` (Lead; locally authored issue)
- [intake-ticket.md](intake-ticket.md) — `intake/<KEY>.md` (task / bug / spike)
- [intake-story.md](intake-story.md) — `intake/<KEY>.md` (story; includes `## Coordination` section)
- [intake-epic.md](intake-epic.md) — `intake/<KEY>.md` (epic)
- [any-index.md](any-index.md) — generic shape for any pillar's shallow `index.md` (header + table + Rules + When to use / NOT use). Use as the starting point for `intake/index.md`, `plans/index.md`, `specs/index.md`, `exploring/index.md`, `issues/index.md`.
