---
human_revised: false
summary: Eager delivery and application triggers for framework-shipped quality execution disciplines.
apps: [meta]
---
...
quality knowledge. Every installed discipline is delivered at context start;
eager delivery does not mean universal application.
...
| code-comments | Code, tests, scripts, or configuration are written, edited, reviewed, refactored, or documented where comments may be affected. |
