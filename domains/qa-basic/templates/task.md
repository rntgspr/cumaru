...
targets: "[unit] | [integration] | [e2e] | [all]   # test levels this case is written at"
aux: []
summary: Framework guidance for T<N> — <case title> and its required workflow.
---
...
- [ ] Scenarios authored at the level(s) in `targets:`, each mapping to an acceptance criterion.
