...
Proposed changes to `coverage/` resulting from this campaign. **The Lead validates and finalizes** as `plans/<PLAN-ID>/delta-draft.md` during direct absorption. Do not edit `coverage/` directly.
