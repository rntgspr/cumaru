...
targets: "[dev] | [staging] | [prod] | [all]   # environments this step applies to"
aux: []
summary: Framework guidance for T<N> — <apply-step title> and its required workflow.
---
...
- [ ] Applied to the target environment(s) in `targets:`.
