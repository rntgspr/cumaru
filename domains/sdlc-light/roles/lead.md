...
5. After confirmation, remove the completed plan with `cumaru flow plans/<PLAN-ID> remove`; this domain keeps durable local trace through each spec's `deltas:` list.
