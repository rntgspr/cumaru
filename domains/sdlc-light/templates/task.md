...
Background an implementing Lead or delegated sub-agent needs that is not in
`specs/`: rationale, links, code references, prior decisions affecting this task.
