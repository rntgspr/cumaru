...
- [handoff.md](handoff.md) — `plans/<PLAN-ID>/handoff-t<N>.md` (Lead or delegated sub-agent, transient evidence per task)
- [delta-draft.md](delta-draft.md) — `plans/<PLAN-ID>/delta-draft.md` (Lead, proposed claims for direct absorption)
